...
class Keys{
  static Color title=const Color(0xff7E73AE);
  static Color title2=const Color(0xffA69BD8);
  static Color title3=const Color(0xff767E8D);
  static Color title4=const Color(0xff4F5050);
